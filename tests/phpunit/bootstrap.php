...
// Make CRM_Mailbatch_ExtensionUtil available.
require_once __DIR__ . '/../../mailbatch.civix.php';
...
addExtensionToClassLoader($loader, 'de.systopia.mailbatch');
 ...
 */
function _mailbatch_test_civicrm_container(ContainerBuilder $container): void {
}
