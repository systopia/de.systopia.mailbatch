 ...
 */
class CRM_Mailbatch_Upgrader_Base {

  /**
   * @var CRM_Mailbatch_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Mailbatch_Upgrader(
        'de.systopia.mailbatch',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Mailbatch_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Mailbatch_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
